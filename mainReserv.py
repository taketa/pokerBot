...
################################################################
			...
			def action():
				...
				while rounddd()==0 and lastHand()[0].split(' ')[-1]==indicator:
					chattx()
					...
					if didI() and lastHand()[0].split(' ')[-1]==indicator:
						if position()=='oop':
					...
					if didI() and lastHand()[0].split(' ')[-1]==indicator:
						if position()=='oop':
							try:eval(lineIP)
								...
								if evaluatePostFlop(diapazonPercent(diapazon1,0.33))>=0.5:bettx()
								checkkx()
							else:
					...
					if didI() and lastHand()[0].split(' ')[-1]==indicator:
						if position()=='oop':
							try:eval(lineIP)
								...
								# print(evaluate.diapazonPercent(diapazon,0.33))
								# print(evaluate.evaluatePostFlop(evaluate.diapazonPercent(diapazon,0.33)))
								if evaluatePostFlop(diapazonPercent(diapazon2,0.33))>=0.5:bettx()
								checkkx()
							else:
								if lineIP[-1]!='r' and lineIP[-1]!='b':
					...
					if didI() and lastHand()[0].split(' ')[-1]==indicator:
						if position()=='oop':
							try:eval(lineIP)
								...
								# print(evaluate.diapazonPercent(diapazon,0.33))
								# print(evaluate.evaluatePostFlop(evaluate.diapazonPercent(diapazon,0.33)))
								if evaluatePostFlop(diapazonPercent(diapazon3,0.33))>=0.5:bettx()
								checkkx()
							else:
								if lineIP[-1]!='r' and lineIP[-1]!='b':
